...
maintainers by opening an issue with the `conduct` label. If the matter is sensitive and
should not be discussed in public, say so in a brief issue without details and a private
channel will be arranged.

All complaints will be reviewed and investigated promptly and fairly. Maintainers are obliged
