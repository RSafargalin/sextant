...
Хуков он **не** регистрирует. Хук adoption — живая половина метрики — срабатывает перед каждым
вызовом инструмента и начинает писать в тот же момент, как его зарегистрировали, поэтому его
установка остаётся решением, которое принимаете вы, а не установка за вас: `sextant hook --install`
печатает сниппет и говорит, что именно пишется.
